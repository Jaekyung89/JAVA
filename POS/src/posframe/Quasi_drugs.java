...
public class Quasi_drugs implements ActionListener {
	...
	public Quasi_drugs(Main PosMain) {
		quasi_drugsframe = new JFrame();
		quasi_drugsframe.setBounds(0, 0, 1200, 950);
		quasi_drugsframe.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		quasi_drugsframe.getContentPane().setLayout(null);
		quasi_drugsframe.setLocationRelativeTo(null);
		quasi_drugsframe.setResizable(false);
        ...
        quasi_drugsframe.setVisible(false);
	}
	

	private void quasi_drugsPanel() {
		quasi_drugsPanel = new JPanel();
		quasi_drugsPanel.setLayout(null);
		quasi_drugsPanel.setBounds(0, 0, 1200, 950);
        PosMain.getMainPanel().add(quasi_drugsPanel);
        
        quasi_drugsmp1();
		
    }

	private void quasi_drugsmp1() {
		quasi_drugsmp1 = new JPanel();
		quasi_drugsmp1.setLayout(null);
		quasi_drugsmp1.setBounds(0, 0, 1200, 950);
        quasi_drugsPanel.add(quasi_drugsmp1);
    ...
    private void sp5() {
    	...
    	try {
			while(rs.next()) {
		        ...
		        bvgbtn[i] = createButton("javaImage/quasi_drugs/drug" + (i+1) + ".png", NAME, PRICE);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj == GoHome) {
			quasi_drugsPanel.setVisible(false);
