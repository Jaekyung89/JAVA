...
public class Ice_cream implements ActionListener {
	...
	private void ice_creammp1() {
		ice_creammp1 = new JPanel();
		ice_creammp1.setLayout(null);
		ice_creammp1.setBounds(0, 0, 1200, 950);
        ice_creamPanel.add(ice_creammp1);
    ...
    private void sp5() {
    	...
    	try {
			while(rs.next()) {
		        ...
		        bvgbtn[i] = createButton("javaImage/ice_cream/ice" + (i+1) + ".png", NAME);
