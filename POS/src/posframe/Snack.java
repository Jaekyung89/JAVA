...
public class Snack implements ActionListener {
	...
	private void snackmp1() {
		snackmp1 = new JPanel();
		snackmp1.setLayout(null);
		snackmp1.setBounds(0, 0, 1200, 950);
        snackPanel.add(snackmp1);
    ...
    private void sp5() {
    	...
    	try {
			while(rs.next()) {
		        ...
		        bvgbtn[i] = createButton("javaImage/snack/snack" + (i+1) + ".png", NAME, PRICE);
